...
public class DatabaseManager : MonoBehaviour
{
    ...
    public IEnumerator RegisterPlayer(string username, string password)
    {
        ...
        using (UnityWebRequest www = UnityWebRequest.Post("http://192.168.0.14/UnityFindME/add_player.php", form))
        {
    ...
    {
        using (UnityWebRequest www = UnityWebRequest.Get("http://192.168.0.14/UnityFindME/get_player.php?username=" + username))
        {
            yield return www.SendWebRequest();
