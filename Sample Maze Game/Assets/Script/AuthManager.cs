...
public class AuthManager : MonoBehaviour
{
    ...
    // URL to PHP files
    private string signUpURL = "http://192.168.41.90/UnityFindME/add_player.php"; 
    private string loginURL = "http://192.168.41.90/UnityFindME/login_player.php?"; 
    private string getCoinsURL = "http://192.168.41.90/UnityFindME/get_player_info.php"; 
