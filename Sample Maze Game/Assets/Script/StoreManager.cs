...
public class StoreManager : MonoBehaviour
{
    ...
    private string updateCoinsURL = "http://192.168.43.237/UnityFindME/update_coins_store.php"; 
    private string buyPowerUpURL = "http://192.168.43.237/UnityFindME/buy_powerup.php"; 
    ...
    private IEnumerator LoadCoinsFromDatabase(string username)
{
    ...
    using (UnityWebRequest www = UnityWebRequest.Post("http://192.168.43.237/UnityFindME/get_coins.php", form)) // Adjust URL
    {
